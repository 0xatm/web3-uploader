...
var Web3Uploader = function (_a) {
    ...
    var _e = react_1.useState(), storage = _e[0], setStorage = _e[1];
    var _f = react_1.useState([]), fileList = _f[0], setFileList = _f[1];
    react_1.useEffect(function () {
        console.log('apiToken:', apiToken);
        setStorage(new web3_storage_1.Web3Storage({ token: apiToken }));
    }, []);
    react_1.useEffect(function () {
    ...
    return (react_1.default.createElement("section", { className: "container" },
        react_1.default.createElement("div", __assign({}, getRootProps({ className: 'dropzone' })),
            react_1.default.createElement("input", __assign({}, getInputProps(), { disabled: isFileLoading })),
